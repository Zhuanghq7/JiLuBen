...
import cn.zhuangh7.jiluben.activity.mApplication;

/**
 * Created by lfkdsk on 2016/9/18.
 */
public class SwipeWindowHelper extends Handler {
    ...
    class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            mApplication application = (mApplication) mCurrentWindow.getContext().getApplicationContext();
